...
namespace CrudMvc.Controllers
{
    public class CurriculumController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Genero,Edad")] Curriculum curriculum)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Genero,Edad")] Curriculum curriculum)
        {
            if (id != curriculum.Id)
            {
                return NotFound();
